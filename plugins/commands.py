...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🍙 Movie Updates 🍙', url=f"https://telegram.me/MOVIESUPDAT95"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton(' ♥️ғᴏʟʟᴏᴡ', url='https://www.instagram.com/amitbhai_ff0?igsh=N2Q5ZW5lMGMxaDkz')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
